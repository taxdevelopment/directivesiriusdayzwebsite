  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <h3 className='mb-4 text-3xl tracking-tight font-extrabold text-slate-900 dark:text-white'>
          {title}
        </h3>
        <p className='md:mb-6 font-light text-slate-500 md:text-lg dark:text-slate-400'>
          {description}
        </p>
      </div>
    </div>
